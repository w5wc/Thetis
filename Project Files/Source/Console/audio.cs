        ...
        public static void EnableVAC1(bool enable)
        {
            ...
            if (enable)
                unsafe
                {
                    ...
                    double out_latency = vac1_latency_manual ? latency2_out / 1000.0 : PA19.PA_GetDeviceInfo(output_dev2).defaultLowOutputLatency;
                    ...
                    double pa_out_latency = vac1_latency_pa_in_manual ? latency_pa_out / 1000.0 : PA19.PA_GetDeviceInfo(output_dev2).defaultLowOutputLatency;
